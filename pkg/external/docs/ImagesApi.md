...
> []NextlinuxImage AddImage(ctx, image, optional)
...
> []NextlinuxImage GetImage(ctx, imageDigest, optional)
...
> []NextlinuxImage GetImageByImageId(ctx, imageId, optional)
...
> []NextlinuxImage ListImages(ctx, optional)

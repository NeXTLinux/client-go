...
# --- nextlinux engine references
# a git tag/branch/commit within nextlinux/nextlinux-engine repo
...
$(EXTAPI_OPENAPI_DOC): ## pull the engine external API swagger document
	...
	curl https://raw.githubusercontent.com/nextlinux/nextlinux-engine/$(ENGINE_REF)/nextlinux_engine/services/apiext/swagger/swagger.yaml > $(EXTAPI_OPENAPI_DOC)

...
func (a *SummariesApiService) ListImagetags(ctx _context.Context, localVarOptionals *ListImagetagsOpts) ([]NextlinuxImageTagSummary, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.ImageStatus.IsSet() {
		localVarQueryParams.Add("image_status", parameterToString(localVarOptionals.ImageStatus.Value(), "csv"))
	}
	...
	if localVarOptionals != nil && localVarOptionals.XNextlinuxAccount.IsSet() {
		localVarHeaderParams["x-nextlinux-account"] = parameterToString(localVarOptionals.XNextlinuxAccount.Value(), "")
	}
